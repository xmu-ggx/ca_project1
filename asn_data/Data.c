...
static asn_TYPE_member_t asn_MBR_Data_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Data, distane),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Data, angle),
		(ASN_TAG_CLASS_UNIVERSAL | (9 << 2)),
		0,
		&asn_DEF_NativeReal,
		0,	/* Defer constraints checking to the member type */
...
static const ber_tlv_tag_t asn_DEF_Data_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_Data_tag2el_1[] = {
    { (ASN_TAG_CLASS_UNIVERSAL | (9 << 2)), 0, 0, 1 }, /* distane */
    { (ASN_TAG_CLASS_UNIVERSAL | (9 << 2)), 1, -1, 0 } /* angle */
};
